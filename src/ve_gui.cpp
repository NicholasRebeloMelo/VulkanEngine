...
namespace ve {
    ...
    // using.
    VeImgui::VeImgui(
        VeWindow &window, VeDevice &device, VkRenderPass renderPass, uint32_t imageCount)
        : veDevice{ device } {
    ...
    void VeImgui::render(VkCommandBuffer commandBuffer) {
        ImGui::Render();
        ImDrawData *drawdata = ImGui::GetDrawData();
        ImGui_ImplVulkan_RenderDrawData(drawdata, commandBuffer);
    }

    void VeImgui::runExample() {
