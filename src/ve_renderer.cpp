...
namespace ve {
	...
	{
		assert(isFrameStarted && " Can't call endframe while enfFrame is not in progress");
	...
	{
		assert(isFrameStarted && " Can't call endnSwapChainRenderPass while frame is not in progress");
